...
<body>
    ...
    <div class="row clearfix">
				...
				<div class="col-md-9 column">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource111" Height="417px" Width="806px">
                        <Columns>
                            <asp:BoundField DataField="学年度" HeaderText="学年度" SortExpression="学年度" />
                            <asp:BoundField DataField="学校" HeaderText="学校" SortExpression="学校" />
                        </Columns>
                    </asp:GridView>
                    	<asp:SqlDataSource ID="SqlDataSource111" runat="server" ConnectionString="<%$ ConnectionStrings:ManageSchoolGoalConnectionString %>" SelectCommand="SELECT * FROM [SchoolGoal]"></asp:SqlDataSource>
                    <br />
                    <br />
                    <br />
                    <br />
